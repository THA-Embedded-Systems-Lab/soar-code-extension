...

{
    ...
    assert(objectAttrs.some((a: SoarAttribute) => a.value === '<blockA>'), 'Should have <blockA>');
    assert(objectAttrs.some((a: SoarAttribute) => a.value === '<blockB>'), 'Should have <blockB>');
    assert(objectAttrs.some((a: SoarAttribute) => a.value === '<blockC>'), 'Should have <blockC>');
    assert(objectAttrs.some((a: SoarAttribute) => a.value === '<table>'), 'Should have <table>');
}
...

{
    ...
    assert(blockAAttrs.some((a: SoarAttribute) => a.name === 'name' && a.value === 'A'), 'BlockA should have ^name A');
    assert(blockAAttrs.some((a: SoarAttribute) => a.name === 'type' && a.value === 'block'), 'BlockA should have ^type block');
    ...
    assert(blockBAttrs.some((a: SoarAttribute) => a.name === 'name' && a.value === 'B'), 'BlockB should have ^name B');
    assert(blockBAttrs.some((a: SoarAttribute) => a.name === 'type' && a.value === 'block'), 'BlockB should have ^type block');
    ...
    assert(tableAttrs.some((a: SoarAttribute) => a.name === 'name' && a.value === 'table'), 'Table should have ^name table');
    assert(tableAttrs.some((a: SoarAttribute) => a.name === 'type' && a.value === 'table'), 'Table should have ^type table');
}
