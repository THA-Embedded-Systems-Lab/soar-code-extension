...
import { VisualSoarProject, ProjectContext, DMVertex, LayoutNode, hasChildren } from './visualSoarProject';
...
export class ProjectLoader {
     ...
     */
    getVertexAttributes(vertexId: string, context: ProjectContext): Array<{ name: string, toId: string, comment?: string }> {
        ...
        return vertex.outEdges?.map(edge => ({
            name: edge.name,
            toId: edge.toId,
